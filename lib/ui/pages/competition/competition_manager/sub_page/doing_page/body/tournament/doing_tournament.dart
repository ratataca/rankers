...
class DoingTournament extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => DoingTournamentState();
}

class DoingTournamentState extends State<DoingTournament>{
  @override
