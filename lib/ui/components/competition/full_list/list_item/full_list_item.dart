...
import 'package:tennis_game_management/ui/components/competition/unit/event_icon/icon_new_outline.dart';
...
class FullListItem extends StatelessWidget {
  String playTitle="";
  ...
  FullListItem({String playTitle="", String period="", String place="", String participan=""})
  {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () async {
        final result = await Navigator.pushNamed(context, '/CompetitionListItemView');
      },
